        ...
        <div class="footer_top">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-8">
                    <div class="widgets_container contact_us">
                        ...
                        <div class="footer_contact">
                            <p>Address : 285 Doi Can, Ba Dinh, Ha Noi</p>
                            <p>
                                Phone :
                                <a href="tel:(+84)386875555">(+84)386875555</a>
                            </p>
                            <p><a href="mailto:tien.pv.2054@aptechlearning.edu.vn">Email : tien.pv.2054@aptechlearning.edu.vn</a></p>
                            <ul>
                                <li>
                ...
                <div class="widgets_container product_widget">
                    ...
                    <div class="simple_product">
                        <div class="simple_product_items">
                            <div class="simple_product_thumb">
                                <a href="#"><img src="./public/images/product/14.jpg" alt=""></a>
                            </div>
                            <div class="simple_product_content">
                                ...
                                <div class="product_price">
                                    <span class="old_price">$32.00</span>
                    ...
                    <div class="simple_product_items">
                        <div class="simple_product_thumb">
                            <a href="#"><img src="./public/images/product/28.jpg" alt=""></a>
                        </div>
                        <div class="simple_product_content">
                            <div class="tag_cate">
                                <a href="#">Women,</a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright_area">
                        <p>
                        Copyright © 2022 <a href="#">Aptech</a> All
                        rights Reserved.
                        </p>
                        <img src="./public/images/icon/papyel2.png" alt="">
                    </div>
                </div>
            </div>
        </div>
